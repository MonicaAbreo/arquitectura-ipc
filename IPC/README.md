...
|                                                                                      |
|   +---------------------+         <----------------->       +---------------------+  |
|   |       Cliente       |          Canal IPC Rápido         |                     |  | 
|   | (Mide el tiempo y   |     (Socket de Dominio Unix)      |       Servidor      |  |
|   |  envía el estímulo) |                                   |  (Escucha y responde | |
|   |                     |         <----------------->       |     inmediatamente) |  |
|   +---------------------+                                   +---------------------+  |
|                                                                                      |
+--------------------------------------------------------------------------------------+
...
Abre tu terminal y pega el siguiente comando. Este comando descarga y ejecuta el script de instalación oficial de Rust.
...
Ver el file cargado en la carpeta /resultados
----------------------------------------------------
